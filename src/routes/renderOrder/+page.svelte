...
<div class="container">
	...
	<div class="sidebar" class:open={sidebarOpen}>
		...
		<div class="sidebar-content">
			...
			<div class="notes">
				<h2>
					This example aim to make sense how renderOrder works in threejs and whether scene graph affects
					renderOrder.
				</h2>
				<p><strong>Example Setup:</strong></p>
				<ul>
					<li>
						<span class="green">Green</span> is renderOrder 10 (highest, rendered last) and directly added
						to scene
					</li>
					<li>
						<span class="red">Red shades</span> are grouped under a Object3D which is added to the scene. They
						are depth sorted renderOrder 0 (default)
					</li>
					<li>
						<span class="blue">Blue shades</span> grouped under another Object3D that gets added to scene.
						They have renderOrder 1, 2, 3 respectively
					</li>
				</ul>
				...
				<ul>
					<li>
						You can see green always gets depth discarded by both Red and Green when seeing through red
						and green. When we see green through red and blue, it garauntees green has larger depth value.
						So if either red or blue gets painted first, green will be discarded since it has highest
						renderOrder regardless where it is in the scene graph. This proves `renderOrder` is absolute
				...
				<p>
					<strong>Side note:</strong> Scene graph does not impact the render order, in this example only depth
					sorting and renderOrder sorting impacts render order
				</p>
			</div>
		</div>
	</div>
